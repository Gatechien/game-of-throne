...
class HeroeRepository extends ServiceEntityRepository
{
    ...
    public function add(Heroe $entity, bool $flush = false): void
    {
    ...
    public function findAllHeroesByHouse(int $id)
    {
        $sql = "SELECT *
        FROM heroe, heroe_house
        WHERE heroe.id = heroe_house.heroe_id 
        AND heroe_house.house_id = ".$id.""
        ;
